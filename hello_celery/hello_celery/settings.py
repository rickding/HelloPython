"""
Django settings for hello_celery project.
...
SECRET_KEY = '0$ak9==a7(=w&f)-z&1&gkw&=vd1r(9^ml7xe$l+pba((9e@=g'
...
ROOT_URLCONF = 'hello_celery.urls'
...
WSGI_APPLICATION = 'hello_celery.wsgi.application'
